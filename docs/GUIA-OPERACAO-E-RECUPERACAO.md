...
4. Em banco novo, aplique todas as migrations `001`–`033` na ordem numérica. Em projeto antigo já agendado, aplique primeiro a `011` para pausar os jobs, depois as migrations ainda ausentes, e só reative após o deploy das Functions.

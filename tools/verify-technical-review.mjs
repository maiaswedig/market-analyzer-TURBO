...
assert.equal(migrations.at(-1), '202609070033_causal_tie_rate_and_grade_a_sessions.sql', 'migration diagnóstica mais recente não é a esperada');
...
assert.match(actual, /janela walk-forward calcula sua taxa de empate/i);
assert.match(actual, /sessão UTC, hora, fonte, idade e latência/i);
